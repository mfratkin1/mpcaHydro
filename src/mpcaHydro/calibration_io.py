...
-- Separate from outlets.py DuckDB database for now
...
-- Station metadata (separate from outlets.py station/reach mappings for now)
...
def init_calibration_db(db_path: Union[str, Path], reset: bool = False):
    ...
    Note: This is kept separate from the outlets.py DuckDB database for now.
